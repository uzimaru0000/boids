...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../node_modules/elm-canvas/elm-canvas.js":[function(require,module,exports) {
...
var author$project$Main$GenBirds = function (a) {
	return {$: 'GenBirds', a: a};
};
var author$project$Main$Bird = F3(
	function (pos, vec, axel) {
		return {axel: axel, pos: pos, vec: vec};
	});
var author$project$Main$Pos = F2(
	function (x, y) {
		return {x: x, y: y};
	});
var author$project$Main$maxSpeed = 2;
var author$project$Main$minSpeed = 2;
...
var author$project$Main$divide = F2(
	function (n, pos) {
		return (!n) ? pos : A2(author$project$Main$mul, 1 / n, pos);
	});
...
var author$project$Main$length = function (pos) {
	return elm$core$Basics$sqrt(
		A2(elm$core$Basics$pow, pos.x, 2) + A2(elm$core$Basics$pow, pos.y, 2));
};
var author$project$Main$normal = function (p) {
	return A2(
		author$project$Main$divide,
		author$project$Main$length(p),
		p);
};
...
var author$project$Main$posGenerator = F2(
	function (_n0, _n1) {
		var xmin = _n0.a;
		var xmax = _n0.b;
		var ymin = _n1.a;
		...
		return A3(
			...
			A2(elm$random$Random$float, xmin, xmax),
			A2(elm$random$Random$float, ymin, ymax));
	});
...
var author$project$Main$birdGenerator = F2(
	function (w, h) {
		return A4(
			elm$random$Random$map3,
			author$project$Main$Bird,
			A2(
				author$project$Main$posGenerator,
				_Utils_Tuple2(50, w - 50),
				_Utils_Tuple2(50, h - 50)),
			A3(
				elm$random$Random$map2,
			...
			elm$random$Random$constant(
				A2(author$project$Main$Pos, 0, 0)));
	});
var author$project$Main$height = 640;
var author$project$Main$width = 640;
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		...
		A2(
			elm$random$Random$generate,
			author$project$Main$GenBirds,
			A2(
				elm$random$Random$list,
				100,
				A2(author$project$Main$birdGenerator, author$project$Main$width, author$project$Main$height))));
};
...
var author$project$Main$addForce = F3(
	function (t, v0, f) {
		var v = A2(
			author$project$Main$add,
			A2(author$project$Main$mul, t, f),
			v0);
		return A2(
			author$project$Main$mul,
			A3(
				elm$core$Basics$clamp,
				author$project$Main$minSpeed,
				author$project$Main$maxSpeed,
				author$project$Main$length(v)),
			author$project$Main$normal(v));
	});
...
var author$project$Main$alignmentForce = F2(
	function (birdList, bird) {
		return (!elm$core$List$length(birdList)) ? A2(author$project$Main$Pos, 0, 0) : A2(
			author$project$Main$sub,
			A2(
				author$project$Main$divide,
				elm$core$List$length(birdList),
				A3(
					elm$core$List$foldl,
					author$project$Main$add,
					A2(author$project$Main$Pos, 0, 0),
...
var author$project$Main$birdRadius = 5;
var author$project$Main$cohesionForce = F2(
	function (birdList, bird) {
		return (!elm$core$List$length(birdList)) ? A2(author$project$Main$Pos, 0, 0) : A2(
			author$project$Main$sub,
			A2(
...
var author$project$Main$distance = F2(
	function (p1, p2) {
		return author$project$Main$length(
			A2(author$project$Main$sub, p1, p2));
	});
var author$project$Main$move = F3(
	function (d, v0, f) {
		return A2(
			author$project$Main$add,
			A2(author$project$Main$mul, d, v0),
			A2(
				author$project$Main$mul,
				0.5 * A2(elm$core$Basics$pow, d, 2),
				f));
	});
var author$project$Main$distanceForce = F3(
	function (m, p1, p2) {
		return function (x) {
			return m / x;
		}(
			A2(
				elm$core$Basics$pow,
				2,
				(-author$project$Main$birdRadius) + A2(author$project$Main$distance, p1, p2)));
	});
var author$project$Main$separateForce = F2(
	function (birdList, bird) {
		if (!elm$core$List$length(birdList)) {
			return A2(author$project$Main$Pos, 0, 0);
		} else {
			var fs = A2(
				elm$core$List$map,
				A2(author$project$Main$distanceForce, 1000, bird.pos),
				A2(
					elm$core$List$map,
					function ($) {
						return $.pos;
			...
			var dirs = A2(
				...
				A2(
					elm$core$List$map,
					function (v) {
						return A2(author$project$Main$sub, bird.pos, v);
					},
					A2(
						elm$core$List$map,
						function ($) {
			...
			return A2(
				...
				A3(
					...
					author$project$Main$add,
					A2(author$project$Main$Pos, 0, 0),
					A3(elm$core$List$map2, author$project$Main$mul, fs, dirs)));
		}
	});
var author$project$Main$virtualBird = function (_n0) {
	var pos = _n0.pos;
	var vec = _n0.vec;
	var up = A3(
		author$project$Main$Bird,
		A2(author$project$Main$Pos, pos.x, 0),
		vec,
		A2(author$project$Main$Pos, 0, 0));
	var right = A3(
		author$project$Main$Bird,
		A2(author$project$Main$Pos, author$project$Main$width, pos.y),
		vec,
		A2(author$project$Main$Pos, 0, 0));
	var left = A3(
		author$project$Main$Bird,
		A2(author$project$Main$Pos, 0, pos.y),
		vec,
		A2(author$project$Main$Pos, 0, 0));
	var down = A3(
		author$project$Main$Bird,
		A2(author$project$Main$Pos, pos.x, author$project$Main$height),
		vec,
		A2(author$project$Main$Pos, 0, 0));
	return _List_fromArray(
		[up, down, left, right]);
...
var author$project$Main$birdUpdate = F3(
	function (d, birds, bird) {
		var fix = _List_fromArray(
			[5, 2, 1]);
		var bs = _Utils_ap(
			birds,
			author$project$Main$virtualBird(bird));
		var f = _List_fromArray(
			[
				A2(
				author$project$Main$separateForce,
				A2(
					elm$core$List$filter,
					function (b) {
						return _Utils_cmp(
							A2(author$project$Main$distance, b.pos, bird.pos),
							5 * author$project$Main$birdRadius) < 1;
					},
					bs),
				bird),
				author$project$Main$normal(
				A2(
					author$project$Main$alignmentForce,
					A2(
						elm$core$List$filter,
						function (b) {
							var dis = A2(author$project$Main$distance, b.pos, bird.pos);
							return (_Utils_cmp(dis, 5 * author$project$Main$birdRadius) > 0) && (_Utils_cmp(dis, 6 * author$project$Main$birdRadius) < 1);
						},
						bs),
					bird)),
				author$project$Main$normal(
				A2(
					author$project$Main$cohesionForce,
					A2(
						elm$core$List$filter,
						function (b) {
							var dis = A2(author$project$Main$distance, b.pos, bird.pos);
							return _Utils_cmp(dis, 5 * author$project$Main$birdRadius) < 1;
						},
						bs),
					bird))
			]);
		var a = A3(
			...
			author$project$Main$add,
			A2(author$project$Main$Pos, 0, 0),
			A3(elm$core$List$map2, author$project$Main$mul, fix, f));
		return {
			axel: a,
			pos: A2(
				author$project$Main$add,
				bird.pos,
				A3(author$project$Main$move, d, bird.vec, bird.axel)),
			vec: A3(author$project$Main$addForce, d, bird.vec, bird.axel)
		};
	});
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							birds: A2(
								elm$core$List$map,
								A2(author$project$Main$birdUpdate, d / 50, model.birds),
								model.birds)
						}),
					elm$core$Platform$Cmd$none);
			default:
...
var author$project$Main$birdRender = F2(
	function (r, _n0) {
		var pos = _n0.pos;
		var axel = _n0.axel;
		return A2(
			...
			_List_fromArray(
				[
					...
					A3(
						...
						author$project$Main$length(axel),
						0.5,
						0.5))
				]),
			_List_fromArray(
...
var author$project$Main$clear = function (color) {
	return A2(
		joakin$elm_canvas$Canvas$shapes,
		_List_fromArray(
			[
...
var author$project$Main$vecRender = function (_n0) {
	var pos = _n0.pos;
	var vec = _n0.vec;
	var dir = A2(
		elm$core$Basics$composeR,
		author$project$Main$normal,
		author$project$Main$mul(10))(vec);
	return A2(
		...
		_List_fromArray(
			[
				...
				_Utils_Tuple2(pos.x + dir.x, pos.y + dir.y))
			]));
};
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							A4(avh4$elm_color$Color$rgba, 1, 1, 1, 0.1)),
							A2(
							joakin$elm_canvas$Canvas$shapes,
							_List_fromArray(
								[
									joakin$elm_canvas$Canvas$stroke(avh4$elm_color$Color$blue)
								]),
							A2(elm$core$List$map, author$project$Main$vecRender, model.birds))
						]),
					A2(
						elm$core$List$map,
						author$project$Main$birdRender(author$project$Main$birdRadius),
						model.birds)))
			]));
};
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Main.Bird":{"args":[],"type":"{ pos : Main.Pos, vec : Main.Pos, axel : Main.Pos }"},"Main.Pos":{"args":[],"type":"{ x : Basics.Float, y : Basics.Float }"}},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"GenBirds":["List.List Main.Bird"],"Tick":["Basics.Float"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"List.List":{"args":["a"],"tags":{}}}}})}});
...
},{"elm-canvas":"../node_modules/elm-canvas/elm-canvas.js","./Elm/Main.elm":"Elm/Main.elm"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
